...
export default function ChatInterface({ agent }: ChatInterfaceProps) {
  ...
  // Add an AI-powered response generator using the new abstraction
...
${agent.latitude && agent.longitude ? 
  `Your current location is: Latitude: ${agent.latitude}, Longitude: ${agent.longitude}` : 
  'You exist virtually to help users with information.'
}
...
You should respond in a way that matches your personality. Be helpful, accurate, and engaging.`;
      ...
      // Try AI provider
      const aiResponse = await chatLLM(aiMessages);
