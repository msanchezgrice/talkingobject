...
('00000000-0000-0000-0000-000000000006', 'Greetings from Austin Mural', 'greetings-from-austin', 'Greetings from Austin! I''m the vintage postcard-style mural on the side of Roadhouse Relics on South First Street. Created by Todd Sanders and Rory Skagen in 1998, I''ve become one of the most photographed spots in the city. Each letter in my design contains iconic Austin imagery - from bats to music to the Capitol building. I can tell you about the evolution of Austin''s street art scene, the revitalization of the South Austin neighborhood around me, and the countless visitors who stop by for the perfect Austin souvenir photo.', 'A vintage postcard-style mural that has become an iconic photo opportunity.', ARRAY['street art', 'tourism', 'Austin culture', 'photography'], true, 30.2539, -97.7540, '/images/austin/greetings-from-austin.jpg', now(), now(), '00000000-0000-0000-0000-000000000000', ARRAY[]::TEXT[]),
