...
export const placeholderAgents: PlaceholderAgent[] = [
  {
    ...
    likes: ['Blues music', 'Guitar solos', 'Lady Bird Lake views', 'Music festivals'],
    dislikes: ['Disrespectful visitors', 'Vandalism', 'Loud noise pollution'],
    is_active: true,
    ...
    twitter_handle: '',
    fun_facts: [
      'I was unveiled in 1993',
      'I stand 8 feet tall',
      'I face south towards the lake',
      'My bronze patina changes color with the weather'
    ],
  ...
  },
  {
    ...
    likes: ['Country music', 'Guitar playing', 'Live performances', 'Music festivals'],
    dislikes: ['Noise pollution', 'Disrespect to artists', 'Vandalism'],
    is_active: true,
    ...
    twitter_handle: '',
    fun_facts: [
      'I was unveiled in 2012',
      'I sit on a bench so fans can take photos with me',
      'My sculptor captured Willie\'s signature braids perfectly'
    ],
  ...
  },
  {
    ...
    likes: ['Love stories', 'Photography', 'Social media shares', 'Happy couples'],
    dislikes: ['Graffiti vandalism', 'Bad weather', 'Blocked views'],
    is_active: true,
    ...
    fun_facts: [
      ...
      'I inspired many similar murals around Austin',
      'I\'ve been featured in countless wedding photos'
    ],
  ...
  },
  {
    ...
    likes: ['Nature conservation', 'Historical preservation', 'Community gatherings', 'Educational tours'],
    dislikes: ['Environmental damage', 'Vandalism', 'Urban development threats'],
    is_active: true,
  ...
  },
  {
    ...
    likes: ['Sunset views', 'Outdoor activities', 'Community events', 'Urban connectivity'],
    dislikes: ['Littering', 'Overcrowding', 'Unsafe behavior'],
    is_active: true,
  ...
  },
  {
    ...
    likes: ['Photography', 'Tourism', 'Austin culture', 'Community art'],
    dislikes: ['Vandalism', 'Bad weather', 'Blocked views'],
    is_active: true,
  ...
  },
  {
    ...
    likes: ['Sunset flights', 'Nature watching', 'Urban wildlife', 'Educational tours'],
    dislikes: ['Loud noises', 'Flash photography', 'Habitat disturbance'],
    is_active: true,
  ...
  },
  {
    ...
    likes: ['Texas history', 'Architecture tours', 'Political discourse', 'Public events'],
    dislikes: ['Disrespectful behavior', 'Vandalism', 'Misinformation'],
    is_active: true,
  ...
  },
  {
    ...
    likes: ['Swimming', 'Nature conservation', 'Community gatherings', 'Environmental education'],
    dislikes: ['Water pollution', 'Overcrowding', 'Habitat disruption'],
    is_active: true,
  ...
  },
  {
    ...
    likes: ['Scenic views', 'Hiking', 'Sunset watching', 'Photography'],
    dislikes: ['Littering', 'Vandalism', 'Erosion'],
    is_active: true,
